...
\ifnum\theexerciseID<16 {\input{build/Q1}} \fi
\ifnum\theexerciseID<16 {\input{build/Q2}} \fi
\ifnum\theexerciseID<16 {\input{build/Q3}} \fi
\ifnum\theexerciseID<16 {\input{build/Q4}} \fi
\ifnum\theexerciseID<16 {\input{build/Q5}} \fi
\ifnum\theexerciseID<16 {\input{build/Q6}} \fi
\ifnum\theexerciseID<16 {\input{build/Q7}} \fi
\ifnum\theexerciseID<16 {\input{build/Q8}} \fi
\ifnum\theexerciseID<16 {\input{build/Q9}} \fi
\ifnum\theexerciseID<16 {\input{build/Q10}} \fi
\ifnum\theexerciseID<16 {\input{build/Q11}} \fi
\ifnum\theexerciseID<16 {\input{build/Q12}} \fi
\ifnum\theexerciseID<16 {\input{build/Q13}} \fi
\ifnum\theexerciseID<16 {\input{build/Q14}} \fi
\ifnum\theexerciseID<16 {\input{build/Q15}} \fi
% 				      6
% Frage Nummer 16:   16? 
\ifnum\theexerciseID<16 {\input{build/Q16}} \fi
%
\end{document}