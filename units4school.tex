...
%%                    |
%%                    V
\ifnum\theexerciseID<12 {\input{build/Q1}}  \fi% 1
\ifnum\theexerciseID<12 {\input{build/Q2}}  \fi% 2
\ifnum\theexerciseID<12 {\input{build/Q3}}  \fi% 3
\ifnum\theexerciseID<12 {\input{build/Q4}}  \fi% 4
\ifnum\theexerciseID<12 {\input{build/Q5}}  \fi% 5
\ifnum\theexerciseID<12 {\input{build/Q6}}  \fi% 6
\ifnum\theexerciseID<12 {\input{build/Q7}}  \fi% 7
\ifnum\theexerciseID<12 {\input{build/Q8}}  \fi% 8
\ifnum\theexerciseID<12 {\input{build/Q9}}  \fi% 9
\ifnum\theexerciseID<12 {\input{build/Q10}} \fi%10
\ifnum\theexerciseID<12 {\input{build/Q11}} \fi%11
\ifnum\theexerciseID<12 {\input{build/Q12}} \fi%12
\ifnum\theexerciseID<12 {\input{build/Q13}} \fi%13
\ifnum\theexerciseID<12 {\input{build/Q14}} \fi%14
\ifnum\theexerciseID<12 {\input{build/Q15}} \fi%15
\ifnum\theexerciseID<12 {\input{build/Q16}} \fi%16
\ifnum\theexerciseID<12 {\input{build/Q17}} \fi%17
\ifnum\theexerciseID<12 {\input{build/Q18}} \fi%18
\ifnum\theexerciseID<12 {\input{build/Q19}} \fi%19
\ifnum\theexerciseID<12 {\input{build/Q20}} \fi%20
